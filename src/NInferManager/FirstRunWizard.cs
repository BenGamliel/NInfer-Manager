...
internal sealed class FirstRunWizard : Form
{
        ...
        ModelDownloadService downloads, ApiProxy proxy, Icon icon)
    {
        ...
        var footer = new TableLayoutPanel { Dock = DockStyle.Fill, ColumnCount = 2, Padding = new Padding(26, 12, 26, 14), BackColor = UiTheme.Surface };
    ...
    private TabPage PortPage()
    {
        ...
        fields.Controls.Add(new Label { Text = "Locked mode shows an error instead of silently changing ports when the selected port is unavailable.", AutoSize = true, MaximumSize = new Size(390, 0), ForeColor = UiTheme.Muted, Padding = new Padding(0, 8, 0, 0) }, 1, 2);
    ...
    private static Label Copy(string text) => new() { Text = text, AutoSize = true, MaximumSize = new Size(610, 0), ForeColor = UiTheme.Muted, Font = new Font("Segoe UI Variable Text", 10.5f), Margin = new Padding(0, 0, 0, 24) };
